...
DJANGODIR=/var/www/python/acupuntura/acupuntura            # Django project directory
SOCKFILE=/var/www/python/acupuntura/run/gunicorn.sock  # we will communicte using this unix socket
